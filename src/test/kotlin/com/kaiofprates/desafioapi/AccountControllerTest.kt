...
class AccountControllerTest {
    ...
    @Test
    fun `test find all`(){
    accountRepository.save(Account(name = "Dani", document = "123", phone = "923422341"))
    ...
    @Test
    fun `test find by id`(){
        val account  = accountRepository.save(Account(name = "Dani", document = "123", phone = "923422341"))
    ...
    fun `test create account`(){
        val account  = Account(name = "Dani", document = "123", phone = "923422341")
    ...
    fun `test update account`(){
        val account  = accountRepository
            .save(Account(name = "Dani", document = "123", phone = "923422341"))
            .copy(name = "Updated")
        val json =  ObjectMapper().writeValueAsString(account)
    ...
    fun `test delete`(){
        val account = accountRepository
            .save(Account(name = "maria", document = "123", phone = "3213123"))
